...
const DAILY_SCHEDULE: EventScheduleInput = {
...
describe('isScheduleActiveNow', () => {
  ...
  describe('custom window via endTime', () => {
    const scheduleWith90MinWindow: EventScheduleInput = {
      ...DAILY_SCHEDULE,
  ...
  describe('overnight window (endTime before startTime)', () => {
    const overnightSchedule: EventScheduleInput = {
  ...
  describe('non-recurring (single occurrence)', () => {
    const singleSchedule: EventScheduleInput = {
  ...
  describe('weekly recurrence', () => {
    ...
    const weeklySchedule: EventScheduleInput = {
