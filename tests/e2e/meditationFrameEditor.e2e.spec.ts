 ...
 *
 * NOTE: Most tests are skipped because the MeditationFrameEditor component
 * uses different UI selectors than what these tests expect. The tests need
 * to be updated to match the actual component implementation.
 */
test.describe('MeditationFrameEditor E2E', () => {
  ...
  // TODO: Fix test - Form field selectors don't match actual meditation create form
  test.skip('should display meditation frame editor in collapsed state', async ({ page }) => {
  ...
  // TODO: Fix test - "Edit Video" button selector doesn't match actual UI
  test.skip('should open modal when Edit Video button is clicked', async ({ page }) => {
    // Navigate to meditation with audio file (seeded in global setup)
  ...
  // TODO: Fix test - "Edit Video" button selector doesn't match actual UI
  test.skip('should display frame library with gender filtering', async ({ page }) => {
    await page.goto('/admin/collections/meditations')
    await page.waitForLoadState('networkidle')
    ...
    const frameCount = await page
      .locator(
        '[data-testid="frame-item"], .frame-item, img[alt*="frame"], img[src*="frame"], .frame-library img',
      )
      .count()
  ...
  // TODO: Fix test - "Edit Video" button selector doesn't match actual UI
  test.skip('should display tag filters in frame library', async ({ page }) => {
    await page.goto('/admin/collections/meditations')
  ...
  // TODO: Fix test - "Edit Video" button selector doesn't match actual UI
  test.skip('should show audio player with timeline', async ({ page }) => {
    await page.goto('/admin/collections/meditations')
    await page.click('a[href*="/admin/collections/meditations/"]')
    await page.waitForLoadState('networkidle')
  ...
  // TODO: Fix test - "Edit Video" button selector doesn't match actual UI
  test.skip('should show current frames section', async ({ page }) => {
    await page.goto('/admin/collections/meditations')
    await page.click('a[href*="/admin/collections/meditations/"]')
    await page.waitForLoadState('networkidle')
  ...
  // TODO: Fix test - "Edit Video" button selector doesn't match actual UI
  test.skip('should close modal when Cancel button is clicked', async ({ page }) => {
    await page.goto('/admin/collections/meditations')
    await page.click('a[href*="/admin/collections/meditations/"]')
    await page.waitForLoadState('networkidle')
  ...
  // TODO: Fix test - "Edit Video" button selector doesn't match actual UI
  test.skip('should close modal when Escape key is pressed', async ({ page }) => {
    await page.goto('/admin/collections/meditations')
    await page.click('a[href*="/admin/collections/meditations/"]')
    await page.waitForLoadState('networkidle')
  ...
  // TODO: Fix test - "Edit Video" button selector doesn't match actual UI
  test.skip('should handle meditation without audio file', async ({ page }) => {
  ...
  // TODO: Fix test - "Edit Video" button selector doesn't match actual UI
  test.skip('should show instructions for adding frames', async ({ page }) => {
    await page.goto('/admin/collections/meditations')
    await page.click('a[href*="/admin/collections/meditations/"]')
    await page.waitForLoadState('networkidle')
  ...
  // TODO: Fix test - "Edit Video" button selector doesn't match actual UI
  test.skip('should maintain modal state during navigation within modal', async ({ page }) => {
    await page.goto('/admin/collections/meditations')
    await page.click('a[href*="/admin/collections/meditations/"]')
    await page.waitForLoadState('networkidle')
