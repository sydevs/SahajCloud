...
| `frames`              | `cascadeFrameNodeChange` afterChange. Meditation-frame validation / rounding / sorting / enrichment hooks. Node-weights cache persistence reaching the `latest: true` version row, not the main row alone (#843) | `meditationFrames`                                             |
