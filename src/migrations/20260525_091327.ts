...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`__new__app_cards_v\` (
  	...
  	\`version_default_aspect_ratio\` text DEFAULT 'square',
  	\`version_default_text_color\` text DEFAULT 'black',
  	...
  	\`version_starting_soon_aspect_ratio\` text DEFAULT 'square',
  	\`version_starting_soon_text_color\` text DEFAULT 'black',
  	\`version_starting_soon_alignment\` text DEFAULT 'center',
  	...
  	\`version_live_now_aspect_ratio\` text DEFAULT 'square',
  	\`version_live_now_text_color\` text DEFAULT 'black',
  	\`version_live_now_alignment\` text DEFAULT 'center',
  	...
  	FOREIGN KEY (\`version_default_page_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	...
  	FOREIGN KEY (\`version_starting_soon_page_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	...
  	FOREIGN KEY (\`version_live_now_page_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE set null,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new__app_cards_v\`("id", "parent_id", "version_label", "version_type", "version_default_button_icon_id", "version_default_destination", "version_default_lecture_id", "version_default_album_id", "version_default_meditation_id", "version_default_image_id", "version_default_aspect_ratio", "version_default_text_color", "version_default_alignment", "version_starting_soon_enabled", "version_starting_soon_threshold", "version_starting_soon_button_icon_id", "version_starting_soon_destination", "version_starting_soon_lecture_id", "version_starting_soon_album_id", "version_starting_soon_meditation_id", "version_starting_soon_image_id", "version_starting_soon_aspect_ratio", "version_starting_soon_text_color", "version_starting_soon_alignment", "version_live_now_enabled", "version_live_now_threshold", "version_live_now_button_icon_id", "version_live_now_destination", "version_live_now_lecture_id", "version_live_now_album_id", "version_live_now_meditation_id", "version_live_now_image_id", "version_live_now_aspect_ratio", "version_live_now_text_color", "version_live_now_alignment", "version_schedule_first_date", "version_schedule_firstdate_tz", "version_schedule_end_time", "version_schedule_recurrence_type", "version_schedule_interval", "version_weight", "version_updated_at", "version_created_at", "version__status", "created_at", "updated_at", "snapshot", "published_locale", "latest") SELECT "id", "parent_id", "version_label", "version_type", "version_default_button_icon_id", "version_default_destination", "version_default_lecture_id", "version_default_album_id", "version_default_meditation_id", "version_default_image_id", "version_default_aspect_ratio", "version_default_text_color", "version_default_alignment", "version_starting_soon_enabled", "version_starting_soon_threshold", "version_starting_soon_button_icon_id", "version_starting_soon_destination", "version_starting_soon_lecture_id", "version_starting_soon_album_id", "version_starting_soon_meditation_id", "version_starting_soon_image_id", "version_starting_soon_aspect_ratio", "version_starting_soon_text_color", "version_starting_soon_alignment", "version_live_now_enabled", "version_live_now_threshold", "version_live_now_button_icon_id", "version_live_now_destination", "version_live_now_lecture_id", "version_live_now_album_id", "version_live_now_meditation_id", "version_live_now_image_id", "version_live_now_aspect_ratio", "version_live_now_text_color", "version_live_now_alignment", "version_schedule_first_date", "version_schedule_firstdate_tz", "version_schedule_end_time", "version_schedule_recurrence_type", "version_schedule_interval", "version_weight", "version_updated_at", "version_created_at", "version__status", "created_at", "updated_at", "snapshot", "published_locale", "latest" FROM \`_app_cards_v\`;`)
  await db.run(sql`DROP TABLE \`_app_cards_v\`;`)
  await db.run(sql`ALTER TABLE \`__new__app_cards_v\` RENAME TO \`_app_cards_v\`;`)
  await db.run(sql`UPDATE \`_app_cards_v\` SET \`version_default_destination\` = 'page' WHERE \`version_default_destination\` = 'appPage';`)
  await db.run(sql`UPDATE \`_app_cards_v\` SET \`version_starting_soon_destination\` = 'page' WHERE \`version_starting_soon_destination\` = 'appPage';`)
  await db.run(sql`UPDATE \`_app_cards_v\` SET \`version_live_now_destination\` = 'page' WHERE \`version_live_now_destination\` = 'appPage';`)
  ...
  await db.run(sql`CREATE INDEX \`_app_cards_v_version_default_version_default_page_idx\` ON \`_app_cards_v\` (\`version_default_page_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`_app_cards_v_version_starting_soon_version_starting_so_1_idx\` ON \`_app_cards_v\` (\`version_starting_soon_page_id\`);`)
  await db.run(sql`CREATE INDEX \`_app_cards_v_version_starting_soon_version_starting_so_2_idx\` ON \`_app_cards_v\` (\`version_starting_soon_lecture_id\`);`)
  await db.run(sql`CREATE INDEX \`_app_cards_v_version_starting_soon_version_starting_so_3_idx\` ON \`_app_cards_v\` (\`version_starting_soon_album_id\`);`)
  await db.run(sql`CREATE INDEX \`_app_cards_v_version_starting_soon_version_starting_so_4_idx\` ON \`_app_cards_v\` (\`version_starting_soon_meditation_id\`);`)
  await db.run(sql`CREATE INDEX \`_app_cards_v_version_starting_soon_version_starting_so_5_idx\` ON \`_app_cards_v\` (\`version_starting_soon_image_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`_app_cards_v_version_live_now_version_live_now_page_idx\` ON \`_app_cards_v\` (\`version_live_now_page_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`__new_app_cards\` (
  	...
  	\`default_aspect_ratio\` text DEFAULT 'square',
  	\`default_text_color\` text DEFAULT 'black',
  	...
  	\`starting_soon_aspect_ratio\` text DEFAULT 'square',
  	\`starting_soon_text_color\` text DEFAULT 'black',
  	\`starting_soon_alignment\` text DEFAULT 'center',
  	...
  	\`live_now_aspect_ratio\` text DEFAULT 'square',
  	\`live_now_text_color\` text DEFAULT 'black',
  	\`live_now_alignment\` text DEFAULT 'center',
  	...
  	FOREIGN KEY (\`default_page_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	...
  	FOREIGN KEY (\`starting_soon_page_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	...
  	FOREIGN KEY (\`live_now_page_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE set null,
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_app_cards\`("id", "label", "type", "default_button_icon_id", "default_destination", "default_lecture_id", "default_album_id", "default_meditation_id", "default_image_id", "default_aspect_ratio", "default_text_color", "default_alignment", "starting_soon_enabled", "starting_soon_threshold", "starting_soon_button_icon_id", "starting_soon_destination", "starting_soon_lecture_id", "starting_soon_album_id", "starting_soon_meditation_id", "starting_soon_image_id", "starting_soon_aspect_ratio", "starting_soon_text_color", "starting_soon_alignment", "live_now_enabled", "live_now_threshold", "live_now_button_icon_id", "live_now_destination", "live_now_lecture_id", "live_now_album_id", "live_now_meditation_id", "live_now_image_id", "live_now_aspect_ratio", "live_now_text_color", "live_now_alignment", "schedule_first_date", "schedule_firstdate_tz", "schedule_end_time", "schedule_recurrence_type", "schedule_interval", "weight", "updated_at", "created_at", "_status") SELECT "id", "label", "type", "default_button_icon_id", "default_destination", "default_lecture_id", "default_album_id", "default_meditation_id", "default_image_id", "default_aspect_ratio", "default_text_color", "default_alignment", "starting_soon_enabled", "starting_soon_threshold", "starting_soon_button_icon_id", "starting_soon_destination", "starting_soon_lecture_id", "starting_soon_album_id", "starting_soon_meditation_id", "starting_soon_image_id", "starting_soon_aspect_ratio", "starting_soon_text_color", "starting_soon_alignment", "live_now_enabled", "live_now_threshold", "live_now_button_icon_id", "live_now_destination", "live_now_lecture_id", "live_now_album_id", "live_now_meditation_id", "live_now_image_id", "live_now_aspect_ratio", "live_now_text_color", "live_now_alignment", "schedule_first_date", "schedule_firstdate_tz", "schedule_end_time", "schedule_recurrence_type", "schedule_interval", "weight", "updated_at", "created_at", "_status" FROM \`app_cards\`;`)
  await db.run(sql`DROP TABLE \`app_cards\`;`)
  await db.run(sql`ALTER TABLE \`__new_app_cards\` RENAME TO \`app_cards\`;`)
  await db.run(sql`UPDATE \`app_cards\` SET \`default_destination\` = 'page' WHERE \`default_destination\` = 'appPage';`)
  await db.run(sql`UPDATE \`app_cards\` SET \`starting_soon_destination\` = 'page' WHERE \`starting_soon_destination\` = 'appPage';`)
  await db.run(sql`UPDATE \`app_cards\` SET \`live_now_destination\` = 'page' WHERE \`live_now_destination\` = 'appPage';`)
  await db.run(sql`CREATE INDEX \`app_cards_default_default_button_icon_idx\` ON \`app_cards\` (\`default_button_icon_id\`);`)
  await db.run(sql`CREATE INDEX \`app_cards_default_default_page_idx\` ON \`app_cards\` (\`default_page_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`app_cards_starting_soon_starting_soon_page_idx\` ON \`app_cards\` (\`starting_soon_page_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`app_cards_live_now_live_now_page_idx\` ON \`app_cards\` (\`live_now_page_id\`);`)
  ...
  await db.run(sql`ALTER TABLE \`wm_app_config\` ADD \`shri_mataji_page_id\` integer REFERENCES pages(id);`)
  await db.run(sql`ALTER TABLE \`wm_app_config\` ADD \`sahaja_yoga_page_id\` integer REFERENCES pages(id);`)
  await db.run(sql`ALTER TABLE \`wm_app_config\` ADD \`explore_page_id\` integer REFERENCES pages(id);`)
  await db.run(sql`ALTER TABLE \`wm_app_config\` ADD \`subtle_system_page_id\` integer REFERENCES pages(id);`)
  await db.run(sql`ALTER TABLE \`wm_app_config\` ADD \`fallback_lecture_id\` integer REFERENCES lectures(id);`)
  await db.run(sql`ALTER TABLE \`wm_app_config\` ADD \`ios_app_url\` text;`)
  await db.run(sql`ALTER TABLE \`wm_app_config\` ADD \`android_app_url\` text;`)
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_app_cards\`("id", "label", "type", "default_button_icon_id", "default_destination", "default_app_page", "default_lecture_id", "default_album_id", "default_meditation_id", "default_image_id", "default_aspect_ratio", "default_text_color", "default_alignment", "starting_soon_enabled", "starting_soon_threshold", "starting_soon_button_icon_id", "starting_soon_destination", "starting_soon_app_page", "starting_soon_lecture_id", "starting_soon_album_id", "starting_soon_meditation_id", "starting_soon_image_id", "starting_soon_aspect_ratio", "starting_soon_text_color", "starting_soon_alignment", "live_now_enabled", "live_now_threshold", "live_now_button_icon_id", "live_now_destination", "live_now_app_page", "live_now_lecture_id", "live_now_album_id", "live_now_meditation_id", "live_now_image_id", "live_now_aspect_ratio", "live_now_text_color", "live_now_alignment", "schedule_first_date", "schedule_firstdate_tz", "schedule_end_time", "schedule_recurrence_type", "schedule_interval", "weight", "updated_at", "created_at", "_status") SELECT "id", "label", "type", "default_button_icon_id", "default_destination", "default_app_page", "default_lecture_id", "default_album_id", "default_meditation_id", "default_image_id", "default_aspect_ratio", "default_text_color", "default_alignment", "starting_soon_enabled", "starting_soon_threshold", "starting_soon_button_icon_id", "starting_soon_destination", "starting_soon_app_page", "starting_soon_lecture_id", "starting_soon_album_id", "starting_soon_meditation_id", "starting_soon_image_id", "starting_soon_aspect_ratio", "starting_soon_text_color", "starting_soon_alignment", "live_now_enabled", "live_now_threshold", "live_now_button_icon_id", "live_now_destination", "live_now_app_page", "live_now_lecture_id", "live_now_album_id", "live_now_meditation_id", "live_now_image_id", "live_now_aspect_ratio", "live_now_text_color", "live_now_alignment", "schedule_first_date", "schedule_firstdate_tz", "schedule_end_time", "schedule_recurrence_type", "schedule_interval", "weight", "updated_at", "created_at", "_status" FROM \`app_cards\`;`)
  await db.run(sql`DROP TABLE \`app_cards\`;`)
  await db.run(sql`ALTER TABLE \`__new_app_cards\` RENAME TO \`app_cards\`;`)
  await db.run(sql`PRAGMA foreign_keys=ON;`)
  await db.run(sql`CREATE INDEX \`app_cards_default_default_button_icon_idx\` ON \`app_cards\` (\`default_button_icon_id\`);`)
