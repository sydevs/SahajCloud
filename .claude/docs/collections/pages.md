...
- `lectureClipFilters` (relationship to lecture-tags, hasMany, minRows: 1) - Visible when type is lecture-clips (both types share the same `lecture-tags` collection)
